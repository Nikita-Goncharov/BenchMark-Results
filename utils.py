...
def calculate_average_benchmark_result(results: list[BenchMarkResult]) -> AverageBenchMarkResult:
    ...
    return AverageBenchMarkResult(
        ...
        average_time_per_output_token=sum([result['time_per_output_token'] for result in results])
        / count,
        average_time_to_first_token=sum([result['time_to_first_token'] for result in results])
        / count,
        average_total_generation_time=sum([result['total_generation_time'] for result in results])
        / count,
    )
